...
var schema = {
  ...
  "公医类别": ["div.mima03 > table > tbody > tr:nth-child(1n + 2) > td:nth-child(4)"],
  "地址": ["div.mima03 > table > tbody > tr:nth-child(1n + 2) > td:nth-child(5)"],
  "行政区": ["div.mima03 > table > tbody > tr:nth-child(1n + 2) > td:nth-child(6)"]
};

var keys = _.keys(schema);

var url = 'http://www.gzyb.net/infoquery/QueryGyggyljgData.action';
